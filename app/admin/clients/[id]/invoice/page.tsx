...
<body>
  ...
  function renderCostBalanceSummary(source: any) {
    ...
    const blueAmountStyle = { ...amountStyle, color: "#1e3a8a" } as const;
    ...
    return (
      <section style={{ marginTop: 18, border: "1px solid #cbd5e1", borderRadius: 18, padding: 18, background: "linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)", boxShadow: "0 10px 28px rgba(15, 23, 42, 0.08)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "flex-start", marginBottom: 14 }}>
          ...
          {hasDeduction && <div style={{ padding: "8px 12px", borderRadius: 999, background: "#eff6ff", color: "#1e3a8a", fontWeight: 900, whiteSpace: "nowrap" }}>25% cap applied</div>}
        </div>
  ...
  return (
    <main style={pageStyle}>
      ...
      <div style={{ marginBottom: 18, display: "flex", gap: 16, flexWrap: "wrap" }}>
        <Link href={id ? `/admin/clients/${encodeURIComponent(id)}` : "/admin/clients"} style={{ color: "#1e3a8a", fontWeight: 800, textDecoration: "none" }}>
          ← Main Client Info Page
        </Link>
        <Link href="/admin/invoices" style={{ color: "#1e3a8a", fontWeight: 800, textDecoration: "none" }}>
      ...
      {message && <section style={{ ...cardStyle, borderColor: "#bfdbfe", color: "#1e3a8a", marginBottom: 18 }}>{message}</section>}
      ...
      <section id="invoice-step-1" style={{ ...cardStyle, marginBottom: 18 }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 14, alignItems: "flex-start", flexWrap: "wrap", marginBottom: 14 }}>
          <div>
            <div style={{ color: "#1e3a8a", fontSize: 12, fontWeight: 950, textTransform: "uppercase", letterSpacing: "0.05em" }}>
              Step 1
            </div>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 10,
                  border: "1px solid #1e3a8a",
                  background: preview ? "#1e3a8a" : "#94a3b8",
                  color: "#fff",
                  fontWeight: 950,
                  boxShadow: preview ? "0 2px 6px rgba(30, 58, 138, 0.25)" : undefined,
                  whiteSpace: "nowrap",
                }}
              >
