...
mustContain("admin client invoice page", invoicePage, "Direct Pay");
...
mustContain("admin client invoice page", invoicePage, "Attorney Fee");
mustContain("admin client invoice page", invoicePage, "Filing Fee");
mustContain("admin client invoice page", invoicePage, 'useState("All")');
mustContain("admin client invoice page", invoicePage, "Child-matter-based local payment reporting");
mustContain("admin client invoice page", invoicePage, "Lawsuit-page payments appear here only through allocated child MatterPaymentReceipt rows");
mustContain("admin client invoice page", invoicePage, "This screen previews invoice/remittance data only");
mustContain("admin client invoice page", invoicePage, "Principal and Interest Payments");
mustContain("admin client invoice page", invoicePage, "Filing Fee Payments");
mustContain("admin client invoice page", invoicePage, "Filing Fee and Costs Expended");
mustContain("admin client invoice page", invoicePage, "costsExpendedRows");
mustContain("admin client invoice page", invoicePage, "costsExpendedTable");
mustContain("admin client invoice page", invoicePage, "Cost/Fee Type");
mustContain("admin client invoice page", invoicePage, "Date Entered");
mustContain("admin client invoice page", invoicePage, "costsExpendedCsvRows");
...
mustContain("admin client invoice page", invoicePage, "Case Type");
mustContain("admin client invoice page", invoicePage, "width: 42");
...
mustContain("admin client invoice page", invoicePage, "Billed Amount");
mustContain("admin client invoice page", invoicePage, "Payment Amount");
mustContain("admin client invoice page", invoicePage, "Retainer Fee");
mustContain("admin client invoice page", invoicePage, "invoiceThStyle");
mustContain("admin client invoice page", invoicePage, 'textAlign: "center"');
mustContain("admin client invoice page", invoicePage, "invoiceTdStyle");
mustContain("admin client invoice page", invoicePage, 'tableLayout: "fixed"');
mustContain("admin client invoice page", invoicePage, 'overflowX: "visible"');
mustContain("admin client invoice page", invoicePage, 'overflowWrap: "break-word"');
mustContain("admin client invoice page", invoicePage, "invoiceTotalTdStyle");
mustContain("admin client invoice page", invoicePage, "Totals");
mustContain("admin client invoice page", invoicePage, "displayDate");
mustContain("admin client invoice page", invoicePage, "isoDateOnly");
mustContain("admin client invoice page", invoicePage, "isoDateTime");
mustContain("admin client invoice page", invoicePage, "displayDateRange");
mustContain("admin client invoice page", invoicePage, "dateOfServiceEnd");
mustContain("admin client invoice page", invoicePage, "sortedRemittanceRows");
mustContain("admin client invoice page", invoicePage, "principalInterestRows");
mustContain("admin client invoice page", invoicePage, "principalInterestTotals");
mustContain("admin client invoice page", invoicePage, "filingFeeTotals");
mustContain("admin client invoice page", invoicePage, "totalsForRows");
mustContain("admin client invoice page", invoicePage, "filingFeeRows");
mustContain("admin client invoice page", invoicePage, "isFilingFeePayment");
mustContain("admin client invoice page", invoicePage, "isFeeRecoveryTransactionType");
mustContain("admin client invoice page", invoicePage, "if (isFeeRecoveryTransactionType(row?.transactionType)) return 0");
mustContain("admin client invoice page", invoicePage, "{ feeRecovery: true }");
mustContain("admin client invoice page", invoicePage, "!feeRecovery && <th style={invoiceThStyle}>{sortableHeader(\"Billed Amount\", \"billedAmount\")}</th>");
mustContain("admin client invoice page", invoicePage, "!feeRecovery && <th style={invoiceThStyle}>{sortableHeader(\"Retainer Fee\", \"retainerFee\")}</th>");
mustContain("admin client invoice page", invoicePage, "colSpan={feeRecovery ? 11 : 13}");
mustContain("admin client invoice page", invoicePage, 'type.includes("court fee")');
mustContain("admin client invoice page", invoicePage, 'type.includes("other court fees")');
mustContain("admin client invoice page", invoicePage, "paymentRowsTable");
mustContain("admin client invoice page", invoicePage, "sortField");
mustContain("admin client invoice page", invoicePage, "sortDirection");
mustContain("admin client invoice page", invoicePage, "sortableHeader");
mustContain("admin client invoice page", invoicePage, "changeSort");
mustContain("admin client invoice page", invoicePage, "retainerFeeForReceipt");
mustContain("admin client invoice page", invoicePage, "function numberFromPercent");
mustContain("admin client invoice page", invoicePage, "return numeric / 100");
