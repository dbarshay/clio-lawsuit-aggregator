...
const checks = [
  ...
  ["report_titles_locked", has('if (reportType === "trial-calendar") return "Trial Calendar Report";' ) && has('if (reportType === "appearance-calendar") return "Court Appearance Report";') && has('return "Court Calendar Report";')],
