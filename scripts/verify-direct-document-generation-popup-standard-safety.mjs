...
requireIncludes(popup, 'background: "#00346e"', "navy header/action color");
...
requireIncludes(popup, 'border: disabled ? "1px solid #d1d5db" : "1px solid #00346e"', "navy action border");
requireIncludes(popup, 'background: disabled ? "#f3f4f6" : "#00346e"', "navy action background");
