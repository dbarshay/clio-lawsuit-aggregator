...
mustContain("navy_header", popup, `background: "#1e3a8a"`);
...
mustContain("action_buttons_navy", popup, `border: disabled ? "1px solid #cbd5e1" : "1px solid #1e3a8a"`);
mustContain("action_buttons_navy_background", popup, `background: disabled ? "#f8fafc" : "#1e3a8a"`);
