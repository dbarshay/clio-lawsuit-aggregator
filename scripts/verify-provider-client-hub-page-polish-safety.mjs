...
mustAvoid("client page", page, "Central account profile, billing terms, matter workflow access, and operational notes.");
mustAvoid("client page", page, "Launch account workflows, review related matters, and manage invoice/remittance activity.");
mustAvoid("client page", page, "Internal notes and account-specific reminders for this provider/client.");
mustAvoid("client page", page, "ACCOUNT WORKFLOW");
